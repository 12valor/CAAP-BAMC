...
export default async function ReportsPage({searchParams}:{searchParams:Promise<Raw>}) {
  ...
  return <div className="space-y-6"><PageHeader eyebrow="Administrator workspace" title="Reports" description="Filtered, paginated operational and financial reports. Exports are generated on the server." preview={false}/>
